...
class OpenSearchQueryServiceTest {
    ...
    void 첫_raw배치가_모두_제한이면_다음_배치를_읽어_공개_결과로_페이지를_채운다() throws Exception {
        ...
        SearchResults result = search.search(1L, new SearchInput("검색", List.of(), List.of(), false, null, null, null, 0, 1));
    ...
    private static SearchInput input(List<String> spaceIds) {
        return new SearchInput("검색", spaceIds, List.of(), false, null, null, null, 0, 20);
    }
}
