...
public record MemberEventResponse(
        ...
        @Schema(description = "이력 종류 — INVITED · INVITE_RESENT · INVITE_REVOKED · INVITE_EXPIRED · JOINED · APPROVED · SUSPENDED · REACTIVATED · DEACTIVATED · TEAM_ADDED · TEAM_REMOVED · AVATAR_CHANGED · AVATAR_REMOVED · KEYCLOAK_DISABLED_FAILED",
